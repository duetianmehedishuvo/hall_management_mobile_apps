...
class Rotation3DTransition extends AnimatedWidget {
  const Rotation3DTransition({required Animation<double> turns, this.alignment = Alignment.center, this.child})
  ...
  Widget build(BuildContext context) {
    final double turnsValue = double.parse(turns.toString());
    final Matrix4 transform = Matrix4.identity()
      ..setEntry(3, 2, 0.0006)
      ..rotateY(turnsValue);
    return Transform(transform: transform, alignment: const FractionalOffset(0.5, 0.5), child: child);
  }
}
