              ...
              builder: (context, snapshot) {
                return CustomPaint(
                  ...
                  child: Column(
                    ...
                    children: [
                      //Logo
                      Image.asset("assets/images/ic_delivery_truck.png", color: Colors.white, height: 72, width: 72),
                      //Text
                      const Padding(
                        padding: EdgeInsets.all(16.0),
                        child: Text("Tap and hold to confirm", style: TextStyle(color: Colors.white, fontSize: 20)),
                      ),
                    ],
                  ),
                );
...
class ArcShapePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawShadow(_path.shift(const Offset(0, 1)), color.withAlpha(100), 3, true);
